...
public class UserController {
  ...
  public ResponseEntity<?> registerUser(@RequestBody UserPostDTO userDTO) {
    ...
    public ResponseEntity<?> loginUser(@RequestBody UserPostDTO userDTO, HttpServletRequest request, HttpServletResponse response) {
        try {
  ...
  public ResponseEntity<?> sessionValidation(HttpServletRequest request, Authentication authentication, @RequestParam(required = false) boolean detailed) {
